...
for subset in subsets:
	...
	features_json_dict = {'all_features': all_features, 'selected_features': features, 'features_dir': "/path/to/Kinect/dataset"}
	dump_json('configs/features.json', features_json_dict)

	# call driver with commands
	os.system('python3 driver.py --prepare_data --save_results --test_type cross_val --users p1 p2 p3 --train_iters 25 50 75 100 120 140 160 --hmm_insertion_penalty -80 --cross_val_method stratified --n_splits 5 --cv_parallel --parallel_jobs 5')
