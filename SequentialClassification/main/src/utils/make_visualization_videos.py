...
if __name__ == '__main__':
	...
	parser.add_argument('--input_video_directory', type = str, default = '/path/to/Videos', help = 'Directory path to raw images.')
	parser.add_argument('--input_mediapipe_directory', type = str, default = '/path/to/Mediapipe_Data_July_2020', help = 'Directory path to raw mediapipe data.')
	parser.add_argument('--users', nargs='*', default = None, help = 'The user(s) that will have videos generated for.')
	parser.add_argument('--output_project_directory', type = str, default = '/path/to/output/project/directory/Mediapipe', help = 'Directory path to where the video(s) will be saved.')
