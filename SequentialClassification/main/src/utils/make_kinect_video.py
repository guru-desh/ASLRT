...
if __name__ == '__main__':
	...
	parser.add_argument('--video_filepath', type = str, default = '/path/to/Videos')
	parser.add_argument('--output_project_directory', type = str, default = '/path/to/Kinect', help = 'Directory path to where the video(s) will be saved.')	
	parser.add_argument('--features_filepath', type = str, default = '/path/to/Kinect_Data')
	args = parser.parse_args()

	filename = '08-13-20_p8_4K.alligator_above_bed.0000000000'
